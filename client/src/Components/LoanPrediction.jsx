...
const LoanPrediction = () => {
  ...
  const handlePredict = async () => {
    ...
    if (!applicantIncome || !coapplicantIncome || !loanAmount || !loanAmountTerm ||
        !creditHistory || !married || !dependents || !propertyArea) {
      setErrorMessage('Please fill in all fields before predicting.');
  ...
  return (
    <div className="speedometer-container">
      ...
      <button className='btn' onClick={handlePredict}>Predict</button>
